...
export const FORMULES_DATA = [
  ...
  },
  {
    id: "moto",
    planKey: "MOTO",
    title: "Pass Deux-roues",
    priceDH: 200,
    period: "/ mois",
    popularBadge: null,
    isPopular: false,
    icon: <CarOutlined style={{ fontSize: "20px", color: "#059669" }} />,
    colorTheme: "bg-white/60",
    features: [
      { text: "Accès permanent 24/7 pour motocycles", active: true },
      { text: "Emplacements réservés et sécurisés", active: true },
      { text: "Casiers casques (selon disponibilité ouvrages)", active: true },
    ],
    buttonText: "Sélectionner Moto",
    buttonStyle: "bg-white/80 text-primary hover:bg-white border border-white/80 shadow-sm",
  },
];
