...
export const mockParkings: Parking[] = [
  ...
  recalculerQuotasParking({
    ...
    code: "PRK-CHL",
    nom: "Parking Chellah",
    adresse: "Boulevard Chellah, Rabat",
    capaciteTotale: 220,
    placesReserveesAbonnes: 110,
    pourcentageTickets: 50,
    pourcentageAbonnements: 50,
    pourcentageCorporate: 60,
    pourcentageParticulier: 40,
    quotaTickets: 110,
    quotaAbonnementsTotal: 110,
    quotaCorporate: 66,
    quotaParticulier: 44,
    abonnementsParticulierActifs: 24,
    abonnementsCorporateActifs: 38,
    placesRestantesParticulier: 20,
    placesRestantesCorporate: 28,
    actif: true,
  }),
  recalculerQuotasParking({
    ...
    adresse: "Avenue Mohammed V, Gare Rabat-Ville",
    capaciteTotale: 400,
    placesReserveesAbonnes: 200,
    pourcentageTickets: 50,
    pourcentageAbonnements: 50,
    pourcentageCorporate: 60,
    pourcentageParticulier: 40,
    quotaTickets: 200,
    quotaAbonnementsTotal: 200,
    quotaCorporate: 120,
    quotaParticulier: 80,
    abonnementsParticulierActifs: 56,
    abonnementsCorporateActifs: 94,
    placesRestantesParticulier: 24,
    placesRestantesCorporate: 26,
    actif: true,
  }),
];
