...
export const PARKINGS_CONFIG: ParkingMeta[] = [
  {
    ...
    capacite: 450,
    color: "#16a34a",
    dailyBaseTickets: 2333.33,
    monthlyAboPart: 95000,
    monthlyAboCorp: 70000,
    monthlyBadges: 0,
  },
  {
    id: 1,
    ...
    capacite: 600,
    color: "#003566",
    dailyBaseTickets: 1500,
    monthlyAboPart: 52000,
    monthlyAboCorp: 58000,
    monthlyBadges: 0,
  },
  {
    id: 2,
    ...
    capacite: 350,
    color: "#9333ea",
    dailyBaseTickets: 866.67,
    monthlyAboPart: 38000,
    monthlyAboCorp: 34000,
    monthlyBadges: 0,
  },
  {
    id: 4,
    ...
    capacite: 200,
    color: "#d97706",
    dailyBaseTickets: 533.33,
    monthlyAboPart: 24000,
    monthlyAboCorp: 20000,
    monthlyBadges: 0,
  },
];
...
const MONTH_FACTORS: Record<string, { factor: number; numDays: number; index: number }> = {
  ...
  Avril: { factor: 1.00, numDays: 30, index: 3 },
  Mai: { factor: 1.02, numDays: 31, index: 4 },
  Juin: { factor: 1.05, numDays: 30, index: 5 },
  Juillet: { factor: 1.08, numDays: 31, index: 6 },
  Août: { factor: 1.00, numDays: 31, index: 7 },
  Septembre: { factor: 1.02, numDays: 30, index: 8 },
  Octobre: { factor: 0.98, numDays: 31, index: 9 },
  Novembre: { factor: 0.94, numDays: 30, index: 10 },
  Décembre: { factor: 1.02, numDays: 31, index: 11 },
};
